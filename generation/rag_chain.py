    ...
    def _is_clearly_out_of_scope(self, question: str) -> Tuple[bool, str]:
        ...
        oos_categories = [
            ("sports", ["world cup", "football", "soccer", "basketball", "baseball",
                        ...
                        "premier league", "nfl", "nba", "fifa", "cricket", "tennis", "golf",
                        "hockey", "rugby", "boxer", "ufc", "who beat", "who scored"]),
            ...
            ("programming", ["python", "javascript", "java code", "c++", "react", "flutter",
                             ...
                             "how do i code", "debug this", "compile error", "git merge",
                             "npm install", "pip install", "django", "flask", "node.js", "vue",
                             "angular", "svelte", "tailwind", "bootstrap"]),
            ("celebrity/entertainment", ["taylor swift", "kim kardashian", "net worth",
                                          "who is the actor", "movie cast", "new album",
                                          "oscar winner", "grammy", "celebrity", "influencer",
                                          "youtube channel", "tiktok", "instagram follower"]),
            ("cooking/food", ["recipe for", "how do i cook", "how to cook", "how do i bake",
                             "how to bake", "baking recipe", "bake bread", "bake a cake",
                             "sourdough", "how do i make a cake", "pasta recipe", "how to grill"]),
            ("personal/health advice", ["should i break up", "my boyfriend", "my girlfriend",
                                         "my husband cheated", "diagnose me", "diagnose my",
                                         "am i pregnant", "my mental health", "my boss", "my coworker",
                                         "my family", "depression", "anxiety", "therapy",
                                         "medical advice", "what dosage", "chest pain", "symptom"]),
            ("finance", ["stock price", "bitcoin", "crypto", "ethereum", "investment advice",
                         "mortgage rate", "how to invest", "tax return", "credit score",
                         "roth ira", "401k", "buy stocks", "day trading"]),
            ("math/homework", ["solve this equation", "solve 2x", "calculus problem", "algebra",
                               "geometry proof", "math homework", "my homework", "derivative of",
                               "integral of", "factor this", "find x", "quadratic",
                               "long division", "arithmetic problem"]),
            ("translation", ["translate this", "translate to", "translate hello", "how do you say", "in spanish",
                             "in french", "in german", "in chinese", "in japanese", "in arabic",
                             "hola means", "translation of", "translate "]),
            ("creative writing", ["write me a poem", "write a story", "write a song",
                                  "write a haiku", "compose a", "rap about", "write lyrics",
                                  "creative writing", "fan fiction", "fanfic"]),
            ("general chat/jokes", ["tell me a joke", "make me laugh", "say something funny",
                                    "meaning of life", "what is your name", "who are you",
                                    "are you a robot", "how are you", "what can you do",
                                    "who made you", "do you have feelings"]),
            ("academic/other subjects", ["quantum physics", "theory of relativity",
                                         "world war", "french revolution", "roman empire",
                                         "explain shakespeare", "who wrote hamlet", "the bible",
                                         "the quran", "buddhism", "christianity", "islam",
                                         "philosophy of", "summary of the book"]),
            ("tech/hardware", ["best laptop", "which phone", "iphone", "samsung galaxy",
                              "pc build", "graphics card", "rtx", "macbook", "which gpu",
                              "for gaming", "which cpu", "ram should i buy", "gpu", "cpu for"]),
            ("automotive/DIY", ["car engine", "oil change", "how to fix my car", "brake pad",
                               "transmission", "motorcycle repair", "fix my bike"]),
            ("general trivia (non-marine)", ["capital of", "population of france", "population of the us",
                                              "president of the united", "largest country",
                                              "how tall is", "how old is", "what is the distance",
                                              "currency of"]),
            ("task assistance", ["help me with my resume", "write a cover letter",
                                 "summarize this article", "summarize this pdf",
                                 "rewrite this email", "write me an email", "business plan",
                                 "marketing strategy", "study tips"]),
        ]
